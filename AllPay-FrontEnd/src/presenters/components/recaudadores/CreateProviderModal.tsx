...
const CreateProviderModal: React.FC<CreateProviderModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // Si el cambio es en tipo_persona, actualizar también el tipo_documento
  ...
  // Función para validar y guardar, ahora de forma asíncrona
  const handleSave = async () => {
    try {
      ...
      // Formatear los datos según el tipo de persona
      const payload = {
  ...
  // Efecto para sincronizar los campos de dirección entre el hook y el componente
  useEffect(() => {
