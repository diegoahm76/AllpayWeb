        ...
        <div className="p-6 w-full md:w-3/4 lg:w-1/2 flex justify-center items-center">
          <div className='p-4 sm:p-6 bg-slate-200 rounded-xl'>
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-xl">
              ...
              <p className='text-left text-[#562707] font-bold mb-4 mt-4'>{AuthResource.UnlockedPageDescription}</p>
              <FormUnlockedComplete capchaApiKey={CAPCHA_API!} baseApiUrl={BASE_API_URL!} />
            </div>
          </div>
        </div>
      </div>
...
export default UnlockedComplete;
