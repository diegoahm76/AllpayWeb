...
const Usuarios: React.FC = () => {
  ...
  return (
    <div>
      {configurar ? (
        <>
          {(selectedUser as any)?.tipo_persona === 'J' ? (
            <>
              {/* <AdmiusuarioJuridico selectedUser={selectedUser} setconfigurar={setconfigurar} /> */}
            </>
          ) : (
            <>
              {/* <Usuarioadmi selectedUser={selectedUser} setconfigurar={setconfigurar} /> */}
            </>
          )}
        </>
      ) : (
      ...
      {/* <button onClick={() => setconfigurar(!configurar)}>Editar</button> */}
    </div>
  );
};
