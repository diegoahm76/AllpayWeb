...
const transformApiDataToTabla = (apiData: any): CobroPersuasivoTabla => {
  return {
    idCobroPersuasivo: apiData.id_cobro_persuasivo,
    codigoAccion: apiData.cod_accion_registrada,
    descripcion: apiData.descripcion,
    consecutivo: apiData.consecutivo,
    fechaRegistro: apiData.fecha_registro,
    accionRegistrar: apiData.accion_cobro_persuasivo_info?.nombre || 'Sin acción',
    ...
    aplicarPlantilla: apiData.aplicar_plantilla_display,
    documentoAdjunto: apiData.documento_adjunto || 'Sin documento',
    documentoAdjuntoUrl: apiData.documento_adjunto_url,
    fechaCreacion: apiData.fecha_creacion,
    personaCrea: apiData.persona_crea_nombre,
    // Datos de factura
    idFactura: apiData.factura_asociada.id_factura,
    nroFactura: apiData.factura_asociada.nro_factura,
    valorNeto: apiData.factura_asociada.valor_neto,
    fechaCompra: apiData.factura_asociada.fecha_compra,
    recaudador: apiData.factura_asociada.recaudador,
    // URL del documento persuasivo
    docPersuasivoUrl: apiData.doc_persuasivo_url
  };
};
