...
import { getConsultaPlanesPagoInterno } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/notificacion/adapters/consultaDatosDocumentoPlanesPagoNotificacion.adapter';
