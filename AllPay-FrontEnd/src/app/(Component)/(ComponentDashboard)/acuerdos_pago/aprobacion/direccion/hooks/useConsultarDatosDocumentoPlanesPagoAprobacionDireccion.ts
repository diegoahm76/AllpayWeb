...
import { getConsultaPlanesPagoInterno } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/direccion/adapters/consultaDatosDocumentoPlanesPagoAprobacionDireccion.adapter';
