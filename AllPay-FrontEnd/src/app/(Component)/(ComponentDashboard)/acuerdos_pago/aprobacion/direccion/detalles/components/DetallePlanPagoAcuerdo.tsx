...
import { useDetallePlanPagoDireccion } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/direccion/detalles/hooks/useDetallePPDireccion';
import { formatCurrency } from '@/utils/formatters';
import { formatearFechaDMY } from '@/utils/dateUtils';
import DynamicTable from '@/presenters/components/ui/DynamicTable';
import { Button } from '@/presenters/components/ui/AnimatedButton';

export default function DetallePlanPagoAcuerdo() {
    ...
    const {
        ...
        data,
        fetchAllData
    } = useDetallePlanPagoDireccion(idSolicitud || '', token || '');
