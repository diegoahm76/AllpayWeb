...
import { DetallePlanPago } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/detalles/models/DetallePPJuridica.model';
import { detallePlanPagoAdapter } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/detalles/adapters/detallePPJuridica.adapter';

export const useDetallePlanPagoJuridica = (id: string, token: string) => {
