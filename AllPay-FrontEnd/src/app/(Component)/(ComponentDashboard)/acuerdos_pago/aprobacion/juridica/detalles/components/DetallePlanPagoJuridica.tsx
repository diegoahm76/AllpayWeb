...
// hooks
import { useDetallePlanPagoJuridica } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/detalles/hooks/useDetallePPJuridica';
...
export default function DetallePlanPagoJuridica() {
    ...
    const {
        ...
        data,
        fetchAllData
    } = useDetallePlanPagoJuridica(idSolicitud || '', token || '');
