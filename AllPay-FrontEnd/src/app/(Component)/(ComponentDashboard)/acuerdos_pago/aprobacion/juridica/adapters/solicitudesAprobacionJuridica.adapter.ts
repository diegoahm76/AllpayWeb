...
import { SolicitudesAprobacionResponse } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/models/solicitudesAprobacion.model';
...
export const getSolicitudesAprobacionJuridica = async (
    token: string,
    ...
    try {
        ...
        const response = await axios.get<SolicitudesAprobacionResponse>(
            `${baseApiUrl}recaudos/acuerdos-pago/aprobacion/juridica/obtener-solcitiudes-aprobacion/?${params.toString()}`,
            {
                headers: {
