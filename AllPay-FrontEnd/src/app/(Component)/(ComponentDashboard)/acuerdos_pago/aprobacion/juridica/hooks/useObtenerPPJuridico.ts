...
import { getSolicitudesAprobacionJuridica, SolicitudesAprobacionFilters } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/adapters/solicitudesAprobacionJuridica.adapter';
import { SolicitudAprobacion } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/juridica/models/solicitudesAprobacion.model';
    ...
    const fetchData = useCallback(
        async (pageToFetch = page, extraFilters: SolicitudesAprobacionFilters = filters) => {
            ...
            try {
                ...
                const resp = await getSolicitudesAprobacionJuridica(token, merged);
