import { DetallePlanPago, DetallePlanPagoResponse } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/recaudador/detalles/models/DetallePPRecaudador.model';
