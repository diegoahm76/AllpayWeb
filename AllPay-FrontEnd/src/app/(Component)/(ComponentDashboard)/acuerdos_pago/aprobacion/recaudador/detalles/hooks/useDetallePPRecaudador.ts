...
import { DetallePlanPago } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/recaudador/detalles/models/DetallePPRecaudador.model';
import { detallePlanPagoAdapter } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/recaudador/detalles/adapters/detallePPRecaudador.adapter';
