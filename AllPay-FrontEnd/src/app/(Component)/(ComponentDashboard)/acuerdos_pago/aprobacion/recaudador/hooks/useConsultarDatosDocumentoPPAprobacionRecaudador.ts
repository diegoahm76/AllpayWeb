...
import { getConsultaPlanesPagoInterno } from '@/app/(Component)/(ComponentDashboard)/acuerdos_pago/aprobacion/recaudador/adapters/consultaDatosDocumentoPPAprobacionRecaudador.adapter';
