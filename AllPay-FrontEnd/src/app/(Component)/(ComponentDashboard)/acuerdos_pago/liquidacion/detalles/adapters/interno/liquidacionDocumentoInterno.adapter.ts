...
export const getLiquidacionDocumentoInterno = async (
    token: string,
    ...
    try {
        ...
        const response = await axios.get<LiquidacionDocumentoInternoResponse>(
            `${baseApiUrl}recaudos/acuerdos-pago/liquidacion-documento-interno/`,
            {
                params: {
        ...
        throw new Error('Error al generar liquidación de documento interno');
    }
}; 