...
export const obtenerFacturasLiquidadasYnoLiquidadasExterno = async (
    token: string,
    collectorIds: number[],
    page: number = 1,
    searchParams?: {
    ...
    try {
        ...
        const response = await axios.get(`${baseApiUrl}recaudos/facturas-recaudador-externo/?solo_no_pagadas=true&`, {
            headers: {
        ...
        if (axios.isAxiosError(error)) {
            console.error('Error en obtenerFacturasLiquidadasYnoLiquidadasExterno:', {
