...
export interface CollectorInvoice {
  ...
  nombre_comercial_recaudador: string;
...
export const obtenerFacturasLiquidadasYNoLiquidadasInterno = async (
  ...
  try {
    ...
    if (params.tipo_documento_proveedor) queryParams.append('tipo_documento_proveedor', params.tipo_documento_proveedor);
    ...
    const url = `${baseApiUrl}recaudos/facturas-recaudadores/all/?solo_no_pagadas=true&${queryParams.toString()}`;
